...
- **RQ03:** Separamos explicitamente repositórios **inativos** (0 releases) pois representam projetos abandonados ou em estado de manutenção mínima, com características distintas dos projetos ativos. As demais faixas foram definidas considerando práticas comuns de versionamento em projetos Java, onde **baixa atividade** (1-10 releases) sugere projetos em estágio inicial ou com baixa cadência de atualizações, **média atividade** (11-50 releases) indica projetos com desenvolvimento regular e ciclo de releases estabelecido, enquanto **alta atividade** (>50 releases) representa projetos maduros com desenvolvimento contínuo e múltiplas releases ao longo de seu ciclo de vida.
